...
<div class="" id="alamat" style="display:none">{{ $data }}</div>
<script type="text/javascript" src="{{ asset('assets/semuafile/leaflet.js') }}"></script>
<script src="{{ asset('assets/semuafile/batukeliang.js') }}"></script>
<script src="{{ asset('assets/semuafile/batu_keliang_utara.js') }}"></script>
<script src="{{ asset('assets/semuafile/janapria.js') }}"></script>
<script src="{{ asset('assets/semuafile/jonggat.js') }}"></script>
<script src="{{ asset('assets/semuafile/kopang.js') }}"></script>
<script src="{{ asset('assets/semuafile/praya.js') }}"></script>
<script src="{{ asset('assets/semuafile/praya_barat.js') }}"></script>
<script src="{{ asset('assets/semuafile/praya_barat_daya.js') }}"></script>
<script src="{{ asset('assets/semuafile/praya_tengah.js') }}"></script>
<script src="{{ asset('assets/semuafile/praya_timur.js') }}"></script>
<script src="{{ asset('assets/semuafile/peringgarata.js') }}"></script>
<script src="{{ asset('assets/semuafile/pujut.js') }}"></script>
<script src="{{ asset('assets/semuafile/leaflet.uGeoJSON.js') }}"></script>
<script>
